	...
	return (
		<Dialog open={open}>
			...
			<DialogContent
				...
				className="bg-white flex flex-col justify-center w-full font-light gap-y-8 p-2 md:p-8"
			>
				{showDisclaimer && (
					<div className="flex flex-col items-start gap-y-4 max-h-[80vh] overflow-scroll self-end mt-12">
						<DialogTitle className="w-full font-light text-2xl h-full">Wait!</DialogTitle>
