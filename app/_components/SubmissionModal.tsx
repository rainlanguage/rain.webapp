...
export const SubmissionModal = ({
	...
	// Seemingly unnecessary state variable
			...
			for (const deposit of tokenDeposits) {
				...
				if (balance < depositAmount) {
					setError(
						<>
							<p className="mb-3">
								You don not have enough {deposit.tokenInfo.symbol} to cover this deposit.
							</p>
							<p className="mb-3">
			...
			<DialogContent className="bg-white flex flex-col justify-center w-full font-light gap-y-8">
				...
				{showFinalMessage ? (
					<div className="flex flex-col items-start transition-opacity duration-1500 animate-fade-in gap-y-4">
						...
						<div>
							It will continue to trade until removed. If you are interested in creating your own
